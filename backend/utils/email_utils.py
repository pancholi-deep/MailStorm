...
def send_via_gmail_api(access_token: str, to: str, subject: str, body: str, sender_name: str, sender_email: str):
    url = GMAIL_SEND_EMAIL
    headers = {
        "Authorization": f"Bearer {access_token}",
        "Content-Type": "application/json"
    }
    message = create_message(sender_name, sender_email, to, subject, body)
